...
class BurgerBuilder extends Component{
  ...
  /*       axios.get('ingredients.json')
    ...
    updatePurchaseState (ingredients) {
        //Checks if we put any ingredients so we can buy the burger
        ...
        return sum > 0 //if sum > 0 stores true, else false
 ...
 */
    ...
    render (){
        ...
        //if we didn't fetched the data from server we display the spinner
